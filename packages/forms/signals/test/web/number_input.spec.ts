...
describe('numeric inputs', () => {
  ...
  describe('parsing logic', () => {
    ...
    it('should preserve editable number input text after parsing', () => {
      @Component({
        imports: [FormField],
      ...
      act(() => {
        fixture.componentInstance.data.set(2);
      });
...
describe('text input with numeric model', () => {
  ...
  it('should preserve editable text input text after parsing a numeric model', () => {
    @Component({
      imports: [FormField],
    ...
    expect(Object.is(fixture.componentInstance.f().value(), -0)).toBe(true);
    expect(fixture.componentInstance.f().errors()).toEqual([]);
    expect(input.value).toBe('-0');

    setInputValue(input, '1.00005');
    setInputValue(input, '1.0000');
